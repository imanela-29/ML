...
rfcFile = open("RFC.pkl","rb")
modelRFC = pickle.load(rfcFile)

def write():

    st.markdown(f'<p style="color:#f7117d;font-size:40px;text-align:center;"><strong>Random Forest</strong></p>', unsafe_allow_html=True)
    ...
    if submit_button:
        ...
        new_y_pred = modelRFC.predict(new_X_test)
