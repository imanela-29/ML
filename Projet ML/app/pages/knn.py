...
knnFile = open("KNN.pkl","rb")
modelKNN = pickle.load(knnFile)

def write():
    st.markdown(f'<p style="color:#f7117d;font-size:40px;text-align:center;"><strong>K Nearest Neighbours</strong></p>', unsafe_allow_html=True)
    ...
    if submit_button:
        ...
        new_y_pred = modelKNN.predict(new_X_test)
